...
-- Grupo N° 06
-- Integrantes:
-- 1. Angie Saba Córdova
-- 2. Naysha Laura Cueva
-- 3. Jack Guillermo Alvarado
--==========================================================================
...
go
alter table Dim_Ubigeo
add constraint uq_Dim_Ubigeo_latitud_longitud unique (latitud, longitud)
go
...
alter table Dim_Producto
add constraint ck_Dim_Producto_Nombre_Producto01 check (len(Nombre_Producto)>=3)
go
alter table Dim_Producto
